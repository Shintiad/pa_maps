<x-guest-layout>
    <h4 class="pb-2 font-bold text-3xl font-mali">Tambah Desa</h4>
    <!-- Session Status -->
    <x-auth-session-status class="mb-4" :status="session('status')" />

    <form method="POST" action="/desa/add">
        @csrf
        ...
        <div class="mt-4">
            ...
            <x-text-input id="nama_desa" class="block mt-1 w-full" type="text" name="nama_desa" placeholder="Masukkan nama desa" :value="old('nama_desa')" required autocomplete="tel" />
